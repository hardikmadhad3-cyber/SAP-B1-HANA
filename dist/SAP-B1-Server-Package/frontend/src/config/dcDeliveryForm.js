const FORM_SETTINGS_STORAGE_KEY = 'sapb1.dcDelivery.formSettings.v4';
...
const DC_DELIVERY_MATRIX_COLUMNS = [
...
const BASE_MATRIX_COLUMNS = DC_DELIVERY_MATRIX_COLUMNS.map((field) => ({
  ...field,
