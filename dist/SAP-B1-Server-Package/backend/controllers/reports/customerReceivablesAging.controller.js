const service = require("../../services/reports/customerReceivablesAging.service");
...
const sanitizeCriteria = (body = {}) => ({
  groupBy: body.groupBy === "salesEmployee" ? "salesEmployee" : "customer",
  ...
  considerConnectedVendors: Boolean(body.considerConnectedVendors),
});

const errorMessage = (error) => error?.message || "Could not load Customer Receivables Aging report.";
