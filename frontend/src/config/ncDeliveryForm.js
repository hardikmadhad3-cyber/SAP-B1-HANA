const FORM_SETTINGS_STORAGE_KEY = 'sapb1.ncDelivery.formSettings.v4';
...
const NC_DELIVERY_MATRIX_COLUMNS = [
...
const BASE_MATRIX_COLUMNS = NC_DELIVERY_MATRIX_COLUMNS.map((field) => ({
  ...field,
