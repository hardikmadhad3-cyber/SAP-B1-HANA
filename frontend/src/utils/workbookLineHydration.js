...
const canonicalUdfFields = [
  ...
  { canonical: ['U_SELLTCODE'], aliases: udfAlias.stcode, lineAliases: ['stcode', 'STCODE', 'STCode', 'STACode'] },
  { canonical: ['U_S_Item', 'U_S_ITEM'], aliases: udfAlias.sellerItem, lineAliases: ['sellerItem', 'SellerItem'] },
