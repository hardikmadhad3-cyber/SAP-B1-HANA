...
const TABLE_MIN_WIDTH = INDEX_COL_WIDTH + ACTION_COL_WIDTH + MATRIX_COLS.reduce((total, col) => total + col.minWidth, 0);
    ...
    <div className="so-tab-panel" style={{ overflow: 'visible', minWidth: 0, maxWidth: 'none' }}>
      ...
      <div className="so-grid-wrap so-grid-wrap--contents">
        ...
        <table
          ...
          style={{ width: 'max-content', minWidth: TABLE_MIN_WIDTH, tableLayout: 'auto' }}
        >
          <colgroup>
            <col style={{ width: INDEX_COL_WIDTH }} />
            {MATRIX_COLS.map((column) => (
