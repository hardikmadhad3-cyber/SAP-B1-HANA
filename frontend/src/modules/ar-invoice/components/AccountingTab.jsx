        ...
        <div className="sap-tab-section sap-tab-section--full sap-due-date-section">
          ...
          <div className="sap-form-row sap-form-row--full">
            ...
            <div className="sap-inline-row sap-due-date-controls">
              ...
              <label className="sap-inline-label" htmlFor="dueDateSelected">Selected Date</label>
          ...
          <div className="sap-form-row sap-form-row--full">
            ...
            <div className="sap-inline-row sap-due-date-controls">
              ...
              <label className="sap-inline-label" htmlFor="dueDateMonths">Months + Days</label>
          ...
          <div className="sap-checkbox-row">
            <input type="checkbox" id="useShippedGoods" disabled={!isEditable} />
